...
const SalesCompaignBanner = () => {
  const router = useRouter();

  return (
    <div className='w-full bg-gradient-to-r from-red-600 via-orange-600 to-red-600 relative overflow-hidden py-3'>
...
export default SalesCompaignBanner